...
@Composable
fun GurujiLoginScreen(
    navController: NavController,
    viewModel: GurujiLoginViewModel = hiltViewModel()
) {
    ...
    DivineScreen(
        ...
        Column(
            ...
            PremiumAuthHeader(
                title = stringResource(R.string.guruji_login_title),
                subtitle = stringResource(R.string.guruji_login_subtitle),
            ...
            Column(
                ...
                PremiumAuthButton(
                    ...
                    onClick = {
                        ...
                        viewModel.login(context, input, password) {
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text(
                        text = stringResource(R.string.new_guruji_question),
                    ...
                    Text(
                        ...
                        modifier = Modifier.clickable { navController.navigate(Routes.GURUJI_REGISTRATION) }
                    )
                }
        ...
        if (showForgotDialog) {
            DivineForgotPasswordDialog(
                ...
                onReset = { input ->
                    val isValid = input.matches(emailRegex) || input.matches(mobileRegex)
                    if (isValid) {
                        viewModel.resetPassword(input) { msg ->
